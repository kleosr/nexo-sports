...
export default function Footer() {
  return (
    <footer id="contacto" className="bg-nexo-blue text-white">
      <div className="container-custom py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">NEXO SPORTS</h3>
            <p className="mb-4 text-gray-300">
              Tu tienda online de confianza para equipamiento deportivo de alta calidad en toda España.
            </p>
          ...
          {/* Help & Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Ayuda e Información</h3>
            <ul className="space-y-2">
              <li>
                <Link href="#" className="text-gray-300 hover:text-white transition-colors">
                  FAQ
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-blue-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Nexo Sports. Todos los derechos reservados.
            </p>
